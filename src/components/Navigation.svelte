<script lang="ts">
  ...
  const slideTitles: Record<(typeof slideNames)[number], string> = {
    ...
    timeline: 'Convergencia 2025-2026',
    'five-patterns': '5 patrones canónicos',
    'before-the-chaos': 'El estado caótico',
    nlah: 'NLAH — Tsinghua',
    'representation-jump': '+16.8 pts solo por representación',
    'sorpresa-quitar-piezas': 'La sorpresa de quitar piezas',
    'meta-harness': 'Meta-Harness — Stanford',
    transferability: 'La transferibilidad',
    'three-eras': 'Las tres eras',
    'karpathy-layers': 'El mapa completo',
