...
<div class="swiper-slide" bind:this={slideElement}>
  ...
  <div class="slide-content">
    <div class="eyebrow">
      ...
      <span>Harness Engineering · Codigo Sin Siesta · 2026</span>
    </div>
    ...
    <p class="subtitle">
      La diferencia entre un buen agente y uno mediocre<br />
      ya no la marca el modelo — la marca el harness.
    </p>

    <div class="tools-row">
      <span class="tool-badge">NLAH · Tsinghua</span>
      <span class="tool-badge">Meta-Harness · Stanford</span>
      <span class="tool-badge">AutoHarness · DeepMind</span>
      <span class="tool-badge highlight-badge">Marzo 2026</span>
    </div>
...
<style>
  ...
  @media (max-width: 768px) {
    ...
    .title { font-size: clamp(3rem, 13vw, 5rem); text-align: center; width: 100%; }
  ...
  @media (max-width: 480px) {
    .title { font-size: clamp(2.6rem, 13vw, 4rem); text-align: center; width: 100%; }
    .subtitle { font-size: 1rem; }
    .author-avatar { width: 42px; height: 42px; }
    .tool-badge { padding: 10px var(--spacing-md); min-height: 44px; }
  }
</style>
