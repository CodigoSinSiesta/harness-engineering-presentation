...
## Anécdota / hook
La obsesión de Khattab (DSPy) con "make the agent compilable" es prima hermana de la obsesión de Pan con "make the harness ablatable". Dos equipos, dos países, mismo norte.
